      ...
      .subscribe(
        data =>{
          ...
          }else if (data.hasOwnProperty("payUrl"))
          {
            ...
            formData.curl = data.curl;
            formData.email = data.email;
            formData.firstname = data.firstname;
            formData.lastname = data.lastname;
            formData.furl = data.furl;
            formData.hash = data.hash;
            formData.key = data.key;
            formData.phone = data.phone;
            formData.productinfo = data.productinfo;
            formData.requestId = data.requestId;
            formData.surl = data.surl;
            formData.txnid = data.txnid;
