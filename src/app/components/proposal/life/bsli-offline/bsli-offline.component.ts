...
@Component({
  selector: 'app-bsli-offline',
  templateUrl: './bsli-offline.component.html',
  styleUrls: ['./bsli-offline.component.css']
})
export class BsliOfflineComponent implements OnInit {
