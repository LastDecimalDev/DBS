...
submitofflineApp(){
  ...
  if(this.applicationData.requestParams.age == '' || this.applicationData.requestParams.age == undefined || this.applicationData.requestParams.age == null || isNaN(this.applicationData.requestParams.age))
       this.proposalData.insAge = '';
  else this.proposalData.insAge =  this.applicationData.requestParams.age;
  this.proposalData.childAge = '';
  this.proposalData.deathBenefit = this.applicationData.requestParams.sa;
  this.proposalData.sa = this.applicationData.requestParams.ap;
...
getPolicyType(policyType){
  ...
  switch (policyType){
    case '3':
       policyName = "Content Only";
       break;
    case '2':
       policyName = "Building Only";
       break;
    case '1':
       policyName = "Building and Content";
       break;
    case 'INDV':
...
getPolicyTenure(policyType){
  var policyTenure = '';
  switch (policyType){
    case '3':
       policyTenure = 'Content: '+ this.applicationData.requestParams.contentpt+ ' Years';
       break;
    case '2':
        policyTenure = 'Building: '+this.applicationData.requestParams.structpt+ ' Years';
       break;
    case '1':
      policyTenure = 'Building: '+this.applicationData.requestParams.structpt+'/ Content: '+ this.applicationData.requestParams.contentpt + ' Years';
       break;
    }
    return policyTenure;
}
getMaxAge(agelist){
  var maxAge = '';
  var arr=agelist.split(',').map(parseFloat);
  return Math.max(...arr);
}
cleanArray(actual) {
