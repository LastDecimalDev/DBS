...
@Component({
  selector: 'app-tata',
  templateUrl: './tata-saving-trad.component.html',
  styleUrls: ['./tata-saving-trad.component.css']
})
export class TataSavingTradComponent implements OnInit {
...
submitofflineApp(){
    ...
    this.proposalData.childAge = this.applicationData.requestParams.childage;
    this.proposalData.deathBenefit = this.applicationData.requestParams.ap;
